...
function normalizeOptions(options = {}) {
	...
	const optionalRuleNames = ["allied_2_24_exclusive_1941", "moscow_trench_axis_rp", "no_invasions_before_summer_42", "sunny_italy", "time_of_mud"]
	const disableOptionalRules = flag("disable_optional_rules")
	const hasLegacyOptionalRuleSelection = optionalRuleNames.some((name) => Object.hasOwn(options, name))
	...
	return {
		...
		moscow_trench_axis_rp: optionalRule("moscow_trench_axis_rp"),
