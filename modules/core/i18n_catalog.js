...
;(function initCatalog(root, factory) {
	...
	"combat.log.advance_heading": {
		"params": [],
		"zh-CN": "战后推进：",
		"en": "Advance after combat:"
	},
	"combat.log.advance_none": {
		"params": [],
		"zh-CN": "进攻方没有推进。",
		"en": "The attacker does not advance."
	},
	"combat.log.attacker": {
		"params": [],
		"zh-CN": "进攻方：",
	...
	"combat.log.attacker_fire": {
		...
		"zh-CN": "进攻方开火（{strength} CF，{table}）：",
		"en": "Attacker fires ({strength} CF, {table}):"
	},
	"combat.log.attacker_modifiers": {
		"params": [
			"modifiers"
		],
		"zh-CN": "进攻方：{modifiers}",
		"en": "Attacker: {modifiers}"
	},
	...
	"combat.log.column_shifts": {
		"params": [],
		"zh-CN": "火力列位移：",
		"en": "Fire-column shifts:"
	},
	"combat.log.defender": {
		"params": [],
		"zh-CN": "防守方：",
	...
	"combat.log.defender_fire": {
		...
		"zh-CN": "防守方开火（{strength} CF，{table}）：",
		"en": "Defender fires ({strength} CF, {table}):"
	},
	"combat.log.defender_modifiers": {
		"params": [
			"modifiers"
		],
		"zh-CN": "防守方：{modifiers}",
		"en": "Defender: {modifiers}"
	},
	...
	"combat.log.defenders_retreated": {
		"params": [
			"pieces"
		],
		"zh-CN": "此前已退却（0 CF）：{pieces}",
		"en": "Previously retreated (0 CF): {pieces}"
	},
	"combat.log.drm": {
		"params": [
			"modifiers"
		],
		"zh-CN": "掷骰修正：{modifiers}",
		"en": "Die-roll modifiers: {modifiers}"
	},
	...
	"combat.log.fire_result_shifted": {
		"params": [
			"die",
			"base_column",
			"column",
		...
		"zh-CN": "{die} × {base_column}→{column}列 = {loss}",
		"en": "{die} × column {base_column}→{column} = {loss}"
	},
	"combat.log.modifier.beach": {
		"params": [],
		"zh-CN": "滩头",
		"en": "beachhead"
	},
	"combat.log.modifier.combat_card": {
		"params": [
			"card"
		],
		"zh-CN": "战斗牌{card}",
	...
	"combat.log.modifier.event_generic": {
		"params": [],
		"zh-CN": "事件",
		"en": "event"
	},
	"combat.log.modifier.factor": {
		"params": [
			"amount",
			"source"
		],
	...
	"combat.log.modifier.fort": {
		"params": [],
		"zh-CN": "要塞",
		"en": "fort"
	},
	"combat.log.modifier.oos": {
		"params": [],
		"zh-CN": "断补",
		"en": "out of supply"
	},
	"combat.log.modifier.other": {
		"params": [],
		"zh-CN": "其他修正",
		"en": "other modifier"
	},
	"combat.log.modifier.river": {
		"params": [],
		"zh-CN": "跨河进攻",
		"en": "river crossing"
	},
	"combat.log.modifier.terrain": {
		"params": [],
		"zh-CN": "防御地形",
		"en": "defensive terrain"
	},
	"combat.log.modifier.trench": {
		"params": [],
		"zh-CN": "战壕",
		"en": "trench"
	},
	"combat.log.modifier.urban": {
		"params": [],
		"zh-CN": "城市",
		"en": "urban terrain"
	},
	"combat.log.modifier.winter_1942": {
		"params": [],
		"zh-CN": "1942年冬季德军",
		"en": "Winter 1942 German formation"
	},
	"combat.log.outcome_attacker": {
		"params": [
			"defender_loss",
			"attacker_loss"
		],
		"zh-CN": "{defender_loss}:{attacker_loss} 进攻方获胜",
		"en": "{defender_loss}:{attacker_loss} attacker victory"
	},
	"combat.log.outcome_defender": {
		"params": [
			"defender_loss",
			"attacker_loss"
		],
		"zh-CN": "{defender_loss}:{attacker_loss} 防守方获胜",
		"en": "{defender_loss}:{attacker_loss} defender victory"
	},
	"combat.log.outcome_draw": {
		"params": [
			"defender_loss",
			"attacker_loss"
		],
		"zh-CN": "{defender_loss}:{attacker_loss} 平局",
		"en": "{defender_loss}:{attacker_loss} draw"
	},
	"combat.log.overview": {
		"params": [
			"space"
	...
	"combat.log.retreat_cancelled": {
		"params": [],
		"zh-CN": "防守方追加损失并取消撤退。",
		"en": "The defender takes an additional loss and cancels the retreat."
	},
	"combat.log.retreat_heading": {
		"params": [
			"distance"
		],
		"zh-CN": "防守方撤退（{distance}格）：",
		"en": "Defender retreat ({distance} spaces):"
	},
	"combat.log.retreat_path": {
		...
		"zh-CN": "{piece}：{origin} → {path}",
		"en": "{piece}: {origin} → {path}"
	},
	...
	"turn.cards.discard": {
		...
		"zh-CN": "你可以弃置任意数量的手牌，然后补至手牌上限；若当前超限，必须先弃至上限{note}。",
		"en": "You may discard any number of cards before drawing to the hand limit; if over the limit, you must discard down to it{note}."
	},
	...
	"turn.draw.exchange": {
		"params": [],
		"zh-CN": "重抽后仍没有盟军第2号或第24号牌。你可以弃一张 3+ OPS 牌换取盟军第24号牌，或跳过。",
		"en": "You still have neither Allied card 2 nor 24 after redrawing. You may discard a 3+ OPS card to receive Allied card 24, or pass."
	},
	"turn.draw.redraw": {
		"params": [],
		"zh-CN": "初始手牌没有盟军第2号或第24号牌。你可以保留一张牌后重抽、重抽全部手牌，或跳过。",
		"en": "Your initial hand contains neither Allied card 2 nor 24. You may keep one card and redraw, redraw the entire hand, or pass."
	},
	...
	"ui.cards.hand_or_deck": {
		"params": [],
		"zh-CN": "手牌或牌库",
		"en": "Hand or draw pile"
	},
	"ui.cards.hidden_count": {
		"params": [
			"count"
		],
		"zh-CN": "隐藏{count}张牌",
		"en": "{count} hidden cards"
	},
	"ui.cards.my_discard": {
		"params": [],
		"zh-CN": "我的弃牌堆",
	...
	"ui.cards.side_overview": {
		"params": [
			"side"
		],
		"zh-CN": "{side}卡牌总览",
		"en": "{side} card overview"
	},
	"ui.cards.strategy": {
		"params": [
			"side"
	...
	"ui.cards.view_side_piles": {
		"params": [
			"side"
		],
		"zh-CN": "查看{side}牌堆",
		"en": "View {side} card piles"
	},
	"ui.close": {
		"params": [],
		"zh-CN": "关闭",
