...
const { ALLIED, AXIS, AXIS_ROLE, DATA_VERSION, RULESET_VERSION, SCHEMA_VERSION } = require("../core/constants.js")
...
function createInitialState(data, scenario = "Campaign", seed = 1, options = {}) {
	...
	if (data.spaces[MOSCOW]?.name !== "Moscow") throw new Error(`Stalin setup space ${MOSCOW} must be Moscow`)
